...
import { Import, ListFilter, MoreHorizontal, UserCheck } from 'lucide-react';
                              ...
                              <TableRow key={routine.id}>
                                ...
                                <TableCell>
                                  <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end">
                                      <DropdownMenuLabel>Acciones</DropdownMenuLabel>
                                      <DropdownMenuItem onClick={() => handleEditClick(routine, "routine")}>
                                        Editar
                                      </DropdownMenuItem>
                                      <DropdownMenuItem>Eliminar</DropdownMenuItem>
                                    </DropdownMenuContent>
                              ...
                              <TableRow key={exercise.id}>
                                ...
                                <TableCell>
                                  <DropdownMenu>
                                    ...
                                    <DropdownMenuContent align="end">
                                      <DropdownMenuLabel>Acciones</DropdownMenuLabel>
                                      <DropdownMenuItem onClick={() => handleEditClick(exercise, "exercise")}>
                                        Editar
                                      </DropdownMenuItem>
                                      <DropdownMenuItem>Eliminar</DropdownMenuItem>
                                    </DropdownMenuContent>
